...
bool Root::Start()
{
	...
	auto hormagaunt1 = CreateGameObject("Hormagaunt");
	hormagaunt1->GetComponent<Transform_Component>()->SetPosition(glm::vec3(0, 0, 40));
	...
	hormagaunt1->GetComponent<BoxColliderComponent>()->SetSize(glm::vec3(0.7f, 1.3, 1.6));
	auto hormagauntMesh1 = CreateGameObjectWithPath("Assets/Meshes/Hormagaunt.fbx");
	hormagauntMesh1->SetName("HormagauntMesh");
	...
	auto hormagaunt2 = CreateGameObject("Hormagaunt");
	hormagaunt2->GetComponent<Transform_Component>()->SetPosition(glm::vec3(0, 0, 40));
	...
	hormagaunt2->GetComponent<BoxColliderComponent>()->SetSize(glm::vec3(0.7f, 1.3, 1.6));
	auto hormagauntMesh2 = CreateGameObjectWithPath("Assets/Meshes/Hormagaunt.fbx");
	hormagauntMesh2->SetName("HormagauntMesh");
	...
	auto hormagaunt3 = CreateGameObject("Hormagaunt");
	hormagaunt3->GetComponent<Transform_Component>()->SetPosition(glm::vec3(0, 0, 40));
	...
	hormagaunt3->GetComponent<BoxColliderComponent>()->SetSize(glm::vec3(0.7f, 1.3, 1.6));
	auto hormagauntMesh3 = CreateGameObjectWithPath("Assets/Meshes/Hormagaunt.fbx");
	hormagauntMesh3->SetName("HormagauntMesh");
	...
	auto hormagaunt4 = CreateGameObject("Hormagaunt");
	hormagaunt4->GetComponent<Transform_Component>()->SetPosition(glm::vec3(0, 0, 40));
	...
	hormagaunt4->GetComponent<BoxColliderComponent>()->SetSize(glm::vec3(0.7f, 1.3, 1.6));
	auto hormagauntMesh4 = CreateGameObjectWithPath("Assets/Meshes/Hormagaunt.fbx");
	hormagauntMesh4->SetName("HormagauntMesh");
	...
	auto hormagaunt5 = CreateGameObject("Hormagaunt");
	hormagaunt5->GetComponent<Transform_Component>()->SetPosition(glm::vec3(0, 0, 40));
	...
	hormagaunt5->GetComponent<BoxColliderComponent>()->SetSize(glm::vec3(0.7f, 1.3, 1.6));
	auto hormagauntMesh5 = CreateGameObjectWithPath("Assets/Meshes/Hormagaunt.fbx");
	hormagauntMesh5->SetName("HormagauntMesh");
