...
public class PlayerAnimations : MonoBehaviour
{
    ...
    public void IdleToHitAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(11, 10, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void RunningToHitAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(32, 8, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void ShootingStandingToHitAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(33, 9, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void WeaponSwapWhileRunningAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(32, 42, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void WeaponSwapWhileIdleAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(11, 43, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void WeaponSwapWhileWalkingBackwardsAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(38, 44, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void WeaponSwapWhileWalkingLeftAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(41, 45, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void WeaponSwapWhileWalkingRightAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(40, 46, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
    ...
    public void WeaponSwapWhileWalkingStraightAnimation()
    {
        ...
        try
        {
            esk.TransitionAnimations(41, 47, 0.1f);
            esk.SetAnimationSpeed(2.0f);
        }
        catch (Exception e)
        {
